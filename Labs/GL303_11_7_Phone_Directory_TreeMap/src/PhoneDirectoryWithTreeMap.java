...
public class PhoneDirectoryWithTreeMap {
     ...
     *    not occur in the phone directory, return value is null.
     */
    ...
    public void putNumber(String name, String number) {
        ...
        //else we'll add the name/number pair to the treeMap
        this.data.put(name, number);
    }

    /* Display the contents of the phone directory to System.out*/
    public void print(){
