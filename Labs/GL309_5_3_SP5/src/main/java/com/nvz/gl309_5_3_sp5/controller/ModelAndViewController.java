package com.nvz.gl309_5_3_sp5.controller;

import com.nvz.gl309_5_3_sp5.model.User;
...
//A controller handles HTTP requests, processes them and returns a response in the form of JSON/XML
@Controller
